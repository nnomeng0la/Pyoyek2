        ...
        <div class="-mx-4 flex flex-wrap items-center">
            <div class="w-full px-4">
                <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                    ...
                    <ul class="mb-10 flex flex-wrap items-center justify-center">
                        <li>
                            <a href="https://links.tailgrids.com/play-download" class="inline-flex items-center justify-center rounded-lg bg-white py-4 px-6 text-center text-base font-medium text-dark transition duration-300 ease-in-out hover:text-primary hover:shadow-lg sm:px-10">
                                Download Now
                            </a>
                        </li>
                        <li>
                    ...
                    <div class="wow fadeInUp text-center" data-wow-delay=".3s">
                        <img src="<?php echo base_url('assets/images/hero/brand.svg') ?>" alt="image" class="mx-auto w-full max-w-[250px] opacity-50 transition duration-300 ease-in-out hover:opacity-100" />
                    </div>
                </div>
            </div>
            ...
            <div class="w-full px-4">
                <div class="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s">
                    <div class="mt-16">
                        <img src="<?php echo base_url('assets/images/hero/hero-image.jpg') ?>" alt="hero" class="mx-auto max-w-full rounded-t-xl rounded-tr-xl" />
                    </div>
                    ...
                    <div class="items-center justify-between overflow-hidden border lg:flex">
                        ...
                        <div class="text-center">
                            <div class="relative z-10 inline-block">
                                <img src="<?php echo base_url('assets/images/about/about-image.svg') ?>" alt="image" class="mx-auto lg:ml-auto" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex flex-wrap">
              ...
              ">
                    ...
                    <div class="ud-testimonial-info flex items-center">
                        <div class="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                            <img src="<?php echo base_url('assets/images/testimonials/author-01.png') ?>" alt="author" />
                        </div>
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/3">
              ...
              ">
                    ...
                    <div class="ud-testimonial-info flex items-center">
                        <div class="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                            <img src="<?php echo base_url('assets/images/testimonials/author-02.png') ?>" alt="author" />
                        </div>
                        <div class="ud-testimonial-meta">
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/3">
              ...
              ">
                    ...
                    <div class="ud-testimonial-info flex items-center">
                        <div class="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                            <img src="<?php echo base_url('assets/images/testimonials/author-03.png') ?>" alt="author" />
                        </div>
                        <div class="ud-testimonial-meta">
                    ...
                    <div class="ud-brands-logo flex flex-wrap items-center">
                        <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                            <a href="https://tailgrids.com" target="_blank" rel="nofollow noopner">
                                <img src="<?php echo base_url('assets/images/brands/tailgrids.svg') ?>" alt="tailgrids" class="grayscale duration-300 hover:filter-none" />
                            </a>
                        </div>
                        <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                            <a href="https://ayroui.com" target="_blank" rel="nofollow noopner">
                                <img src="<?php echo base_url('assets/images/brands/ayroui.svg') ?>" alt="ayroui" class="grayscale duration-300 hover:filter-none" />
                            </a>
                        </div>
                        <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                            <a href="https://uideck.com" target="_blank" rel="nofollow noopner">
                                <img src="<?php echo base_url('assets/images/brands/uideck.svg') ?>" alt="uideck" class="grayscale duration-300 hover:filter-none" />
                            </a>
                        </div>
                        <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                            <a href="https://graygrids.com" target="_blank" rel="nofollow noopner">
                                <img src="<?php echo base_url('assets/images/brands/graygrids.svg') ?>" alt="graygrids" class="grayscale duration-300 hover:filter-none" />
                            </a>
                        </div>
                        <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                            <a href="https://lineicons.com" target="_blank" rel="nofollow noopner">
                                <img src="<?php echo base_url('assets/images/brands/lineicons.svg') ?>" alt="lineicons" class="grayscale duration-300 hover:filter-none" />
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
            <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp mb-10" data-wow-delay=".1s">
                    <div class="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                        <img src="<?php echo base_url('assets/images/team/team-01.png') ?>" alt="image" class="w-full rounded-full" />
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp mb-10" data-wow-delay=".15s">
                    <div class="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                        <img src="<?php echo base_url('assets/images/team/team-02.png') ?>" alt="image" class="w-full rounded-full" />
                        <span class="absolute top-0 left-0 z-[-1]">
                            <svg width="71" height="82" viewBox="0 0 71 82" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="1.29337" cy="80.7066" r="1.29337" transform="rotate(-90 1.29337 80.7066)" fill="#3056D3" />
                                <circle cx="12.6747" cy="80.7066" r="1.29337" transform="rotate(-90 12.6747 80.7066)" fill="#3056D3" />
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp mb-10" data-wow-delay=".2s">
                    <div class="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                        <img src="<?php echo base_url('assets/images/team/team-03.png') ?>" alt="image" class="w-full rounded-full" />
                        <span class="absolute top-0 left-0 z-[-1]">
                            <svg width="71" height="82" viewBox="0 0 71 82" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="1.29337" cy="80.7066" r="1.29337" transform="rotate(-90 1.29337 80.7066)" fill="#3056D3" />
                                <circle cx="12.6747" cy="80.7066" r="1.29337" transform="rotate(-90 12.6747 80.7066)" fill="#3056D3" />
              ...
              ">
                    ...
                    <form>
                        <div class="mb-6">
                            ...
                            <input type="text" name="fullName" placeholder="Adam Gelius" class="w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-primary focus:outline-none" />
                        </div>
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="phone" placeholder="+885 1254 5211 552" class="w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-primary focus:outline-none" />
                        </div>
                        <div class="mb-6">
