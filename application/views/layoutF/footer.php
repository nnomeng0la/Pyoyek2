<footer class="wow fadeInUp relative z-10 bg-black pt-20 lg:pt-[120px]" data-wow-delay=".15s">
            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
                <div class="mb-10 w-full">
                    <a href="javascript:void(0)" class="mb-6 inline-block max-w-[160px]">
                        <img src="<?php echo base_url('assets/images/logo/logo.png') ?>" alt="logo" class="max-w-full" />
                    </a>
            ...
            <div class="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
                <div class="mb-10 w-full">
                    ...
                    <ul class="flex flex-wrap items-center">
                        <li>
                            <a href="https://tailgrids.com" rel="nofollow noopner" target="_blank" class="mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]">
                                <img src="<?php echo base_url('assets/images/footer/brands/tailgrids.svg') ?>" alt="tailgrids" />
                            </a>
                        </li>
                        <li>
                            <a href="https://ayroui.com" rel="nofollow noopner" target="_blank" class="mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]">
                                <img src="<?php echo base_url('assets/images/footer/brands/ayroui.svg') ?>" alt="ayroui" />
                            </a>
                        </li>
                        <li>
                            <a href="https://ecommercehtml.com" rel="nofollow noopner" target="_blank" class="mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]">
                                <img src="<?php echo base_url('assets/images/footer/brands/ecommerce-html.svg') ?>" alt="ecommerce-html" />
                            </a>
                        </li>
                        <li>
                            <a href="https://graygrids.com" rel="nofollow noopner" target="_blank" class="mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]">
                                <img src="<?php echo base_url('assets/images/footer/brands/graygrids.svg') ?>" alt="graygrids" />
                            </a>
                        </li>
                        <li>
                            <a href="https://lineicons.com" rel="nofollow noopner" target="_blank" class="mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]">
                                <img src="<?php echo base_url('assets/images/footer/brands/lineicons.svg') ?>" alt="lineicons" />
                            </a>
                        </li>
                        <li>
                            <a href="https://uideck.com" rel="nofollow noopner" target="_blank" class="mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]">
                                <img src="<?php echo base_url('assets/images/footer/brands/uideck.svg') ?>" alt="uideck" />
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <div>
        <span class="absolute left-0 top-0 z-[-1]">
            <img src="<?php echo base_url('assets/images/footer/shape-1.svg') ?>" alt="" />
        </span>

        <span class="absolute bottom-0 right-0 z-[-1]">
            <img src="<?php echo base_url('assets/images/footer/shape-3.svg') ?>" alt="" />
        </span>
