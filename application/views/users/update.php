            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="username" name="username" type="text" value="<?= $usersedit->username ?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="email" name="email" type="email" class="form-control" value="<?= $usersedit->email ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <?php
                            $checked_1 = ($usersedit->status == "1") ? "checked" : "";
                            $checked_2 = ($usersedit->status == "2") ? "checked" : "";
                            ?>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input name="status" id="status_0" type="radio" class="custom-control-input" value="1" <?= $checked_1 ?>>
                                <label for="status_0" class="custom-control-label">Aktif</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input name="status" id="status_1" type="radio" class="custom-control-input" value="2" <?= $checked_2 ?>>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <?php
                            $checked_A = ($usersedit->role == "administrator") ? "checked" : "";
                            $checked_P = ($usersedit->role == "public") ? "checked" : "";
                            ?>
                            <div class="custom-control custom-radio custom-control-inline">
