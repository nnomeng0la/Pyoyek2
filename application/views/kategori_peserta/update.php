        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Kelola Referensi Jenis Kegiatan</h3>
                ...
                <div class="card-body">
                    <?php
                    $hidden = ['idedit' => $kategori_pesertaedit->id];
                    ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <div class="input-group">
                                ...
                                <input value="<?= $kategori_pesertaedit->nama ?>" id="nama" name="nama" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
